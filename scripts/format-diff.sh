#!/bin/bash
# From https://github.com/facebook/rocksdb/blob/master/build_tools/format-diff.sh

# For brew installed clang-format, add it's PATH to ENV like:
# export PATH=$PATH:/usr/local/Cellar/clang-format/2017-03-17/share/clang
